...
import {
  ...
  ChevronRight, ExternalLink, Bell, Search, Building2, Images, Quote, Award,
} from "lucide-react";
...
const navItems = [
  ...
  { href: "/admin/testimonials", label: "Testimonials",    icon: Quote,           badge: null },
  { href: "/admin/brands",       label: "Partners / Brands", icon: Award,          badge: null },
