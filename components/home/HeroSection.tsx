...
const slides = [
  {
    ...
    title: "Illuminate Your Spaces with Exquisite LED Design",
    ...
    ctaLink: "/products?category=led-indoor-lighting",
    highlight: "Light",
  },
  {
    badge: "OCEANA LUXURY BATHWARE",
    title: "Exquisite Sanitaryware & Wellness Bath Suites",
    subtitle: "Experience luxury water flow with thermostatic rain showers, smart antibacterial bidet systems, and stunning freestanding bathtubs.",
    image: "https://images.unsplash.com/photo-1584622781564-1d987f7333c1?w=1200&q=80",
    ctaText: "Explore Bathware",
    ctaLink: "/products?category=luxury-sanitaryware",
    highlight: "Water",
  },
  {
    badge: "OCEAN ARCHITECTURAL PARTNER",
    title: "Crafting Perfect Living Environments",
    subtitle: "Sri Lanka's trusted destination for high-end LED setups, imported electrical fixtures, and state-of-the-art interior solutions.",
